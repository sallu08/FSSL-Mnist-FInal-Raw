...
class My_Client(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        s9=softmax(v9)
        global Mb
        Mb=np.column_stack((s0,s1,s2,s3,s4,s5,s6,s7,s8,s9))
        
        np.savetxt("Mb.csv", Mb, delimiter=",")
